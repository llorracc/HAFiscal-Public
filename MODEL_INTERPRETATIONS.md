...
|---|---:|---:|---:|---|
| bare = `_CDC` | **0.25710** | 0.96081 | 0.07129 | this repo, CDC formula |
| `_ESC` | **0.26718** | 0.97148 | 0.05892 | Edmund's `(1−ς)·aLvl`, pre-staged `db48d328` |
...
- **Code default = CDC.** `_interpretation.get_interpretation()` defaults to `'CDC'`
  (`Code/HA-Models/_interpretation.py:45`); an unflagged `do_all.py` run reads the bare
  `Result_AllTarget.txt` (CDC ς=0.25710) and instantiates CDC agent types.
...
**Net:** the default *code switch* says CDC while the shipped *calibration artifacts* are ESC. Any run
...
| Step-1 wealth concept under ESC (BUG-054) | `BUGS_private/HAFiscal_BUG-054_step1_esc_uses_cdc_wealth_correction.md` + `conclusions_private/2026-06-11_esc_step1_wealth_concept_investigation.md` |
