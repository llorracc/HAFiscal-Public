...
\input{./relpath-to-latexroot.ltx}    % Set paths to find resources (defines \latexroot and loads tex-paths.ltx)
...
% Self-citation of the published version of record (QE 17(3), 741-790):
% appears in References with a clickable DOI, with zero body-text footprint.
% Entry lives in HAFiscal.bib (the bib that propagates to -Public) and,
% standalone, in ccdft-HAFiscal.bib (the click-to-download file the title
% page links to).
\nocite{ccdft-HAFiscal}
\nocite{Bardoczy2021}
\nocite{Blanchard2010}
...
\FloatBarrier
\phantomsection
\webanchor{app:Model-without-splurge}\section{\href{\WebBase\#app:Model-without-splurge}{Results in a model without the splurge}}
...
\webanchor{app:Model-without-splurge-intro}\subsection{\href{\WebBase\#app:Model-without-splurge-intro}{Introduction}}
\label{app:Model-without-splurge-intro}

\webanchor{app:nosplurge-matching-impcs}\subsection{\href{\WebBase\#app:nosplurge-matching-impcs}{Matching the iMPCs without the splurge}}
\label{app:nosplurge-matching-impcs}

\webanchor{app:nosplurge-estimating-betas}\subsection{\href{\WebBase\#app:nosplurge-estimating-betas}{Estimating discount factor distributions without the splurge}}
\label{app:nosplurge-estimating-betas}

\webanchor{app:nosplurge-multipliers}\subsection{\href{\WebBase\#app:nosplurge-multipliers}{Multipliers in the absence of the splurge}}
