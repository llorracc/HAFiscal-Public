...
**Generated**: 2025-12-31_11-35

## ⚠️ Repository Architecture Notice

**This is a FORK of the public repository.**

`econ-ark/HAFiscal` is a fork of `llorracc/HAFiscal-Public`.

**Source Repository:** https://github.com/llorracc/HAFiscal-Public  
**Contributing Guide:** [CONTRIBUTING.md](README/CONTRIBUTING.md)

All contributions should be made to `llorracc/HAFiscal-Public`, NOT to this fork.
...
```bash
# Clone repository
git clone https://github.com/econ-ark/HAFiscal-Public.git
cd HAFiscal-Public
...
@misc{carroll2025hafiscal,
  ...
  year={2025},
  howpublished={Public release version (fork)},
  note={Available at \url{https://github.com/econ-ark/HAFiscal-Public}}
}
```
