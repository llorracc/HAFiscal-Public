...
## Instant Exploration (No Installation)

**Just want to see results?** Launch the interactive dashboard in your browser:

[![Launch Dashboard](https://img.shields.io/badge/Launch-Interactive%20Dashboard-orange?style=for-the-badge&logo=jupyter)](https://mybinder.org/v2/gh/llorracc/HAFiscal-Public/HEAD?urlpath=voila%2Frender%2Fdashboard%2Fapp.ipynb)

- No installation required
- Compare fiscal policies in real-time
- Results in 2 minutes (not 100+ hours)
...
#### ...explore policy effects instantly (2 minutes, no installation)

**Launch**: [![Dashboard](https://img.shields.io/badge/Launch-Dashboard-orange)](https://mybinder.org/v2/gh/llorracc/HAFiscal-Public/HEAD?urlpath=voila%2Frender%2Fdashboard%2Fapp.ipynb)  
...
1. [REPLICATION.md § 3](REPLICATION.md#3-installation-instructions) - Set up your environment
...
**Read**: [REPLICATION.md § 3](REPLICATION.md#3-installation-instructions) - Set up your environment  
...
- **Read**: [REPLICATION.md § 3](REPLICATION.md#3-installation-instructions) - Platform-specific installation
...
│   ├── REPLICATION.md           # Complete replication guide (incl. § 3 Installation)
...
3. `README/REPLICATION.md` § 3 - Setup, then §§ 4–6 for replication workflow
4. `Code/README.md` - Code details (if needed)
...
```bash
# 1. Follow installation steps (see REPLICATION.md § 3)
...
# If needed manually: source .venv-{platform}-{arch}/bin/activate
...
**Time**: ~1 hour  
**Documentation**: [REPLICATION.md](REPLICATION.md) (§ 3 Installation, § 4.2 Minimal Verification)
...
| `README/REPLICATION.md` | Complete replication guide (incl. § 3 Installation) | Before full replication |
...
- **Installation**: See [REPLICATION.md § 3](REPLICATION.md#3-installation-instructions) (macOS subsection)
...
- **Installation**: See [REPLICATION.md § 3](REPLICATION.md#3-installation-instructions) (Linux subsection)
...
- **Installation**: See [REPLICATION.md § 3](REPLICATION.md#3-installation-instructions) (Windows/WSL2 subsection)
