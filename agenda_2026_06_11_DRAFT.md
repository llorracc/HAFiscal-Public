...
5. **Baseline 5× brute-force (`welfare6_scenario.py --agent-count-total 160000`, or the `HAFISCAL_AGENTCOUNT_{D,H,C}` env trio)**: ~5 h; only on explicit request for paper-grade SE. (`HAFISCAL_AGENTCOUNT_TOTAL` was never wired — deprecated 2026-06-12.)
