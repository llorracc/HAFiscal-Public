...
# R-g option (a), 2026-08-10: the dashboard is FROZEN against the vendored
# snapshots in dashboard/vendored/ (provenance in DASHBOARD_README.md) —
# never against the live regenerated tree objs, whose vintage drifts.
_VENDORED = os.path.join(os.path.dirname(os.path.abspath(__file__)), "vendored")

obj = open(os.path.join(_VENDORED, "HA_Fiscal_Jacs_snapshot-20260810.obj"), "rb")
...
obj = open(os.path.join(
    _VENDORED, "HA_Fiscal_Jacs_UI_extend_real_snapshot-20260810.obj"), "rb")
