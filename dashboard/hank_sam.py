...
def load_jacobians():
    ...
    """
    # R-g option (a), 2026-08-10: FROZEN against the vendored snapshots in
    # dashboard/vendored/ (provenance in DASHBOARD_README.md) — never against
    # the live regenerated tree objs, whose vintage drifts.
    base_path = Path(__file__).parent / "vendored"

    # Load main Jacobians
    with open(base_path / "HA_Fiscal_Jacs_snapshot-20260810.obj", "rb") as f:
    ...
    with open(base_path / "HA_Fiscal_Jacs_UI_extend_real_snapshot-20260810.obj",
              "rb") as f:
