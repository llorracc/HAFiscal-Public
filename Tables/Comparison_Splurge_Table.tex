...
\begin{table}[tb] % TAXONOMY: table-container harmonization - ORIGINAL: \begin{table}[t]
  ...
  \begin{tabular*}
    {\textwidth}{@{\extracolsep{\fill}}lrrrrrr@{}} % TAXONOMY: tabular-spec harmonization - ORIGINAL: \begin{tabular}{l@{\extracolsep{0.6em}}rrrrr|@{\extracolsep{1em}}r}
    \hline
    & \multicolumn{5}{c}{MPC} & \\
