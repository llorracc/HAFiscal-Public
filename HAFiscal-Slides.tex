...
%% 20250123: Slides for presentation at the Norwegian University of Science and Technology
%%
%% NOTE: This file does NOT source @local/local.sty because:
%% 1. Beamer class conflicts: @local/local.sty is designed for article/report classes, not beamer
%% 2. enumitem package conflict: Loading enumitem from @local/local breaks beamer's [<+->] incremental item syntax
%% 3. Different package requirements: Slides need different packages than the main document (e.g., siunitx instead of dcolumn)
%% 4. Different package requirements: Slides need different packages than the main document (e.g., siunitx instead of dcolumn)
%% 5. Beamer built-in packages: Beamer loads its own versions of many packages (amsmath, graphicx, etc.)
%% This separation allows each document type to use packages most suitable for its class and purpose.

% allow latex to find custom stuff
\input{./relpath-to-latexroot.ltx}    % Define \latexroot and load paths (tex-paths.ltx is loaded by this file) 
...
%% \usepackage{subfigure}                 % MOVED to @local/local.sty  
...
% \usepackage{econark}                   % MOVED to @local/local.sty
...
\ifbool{vblt}{\date[2025-04-04]{4th Annual LAEF Conference \\ Vanderbilt University \\ \medskip 2025-04-04  \\ \medskip \medskip \medskip \href{https://econ-ark.org/}{\small Powered By} \\ \includegraphics[width=0.5in]{./@resources/econ-ark/econ-ark-logo-small.png}}}

\ifbool{ashoka}{\date[2025-03-19]{Ashoka University \\ \medskip 2025-03-19  \\ \medskip \medskip \medskip \href{https://econ-ark.org/}{\small Powered By} \\ \includegraphics[width=0.5in]{./@resources/econ-ark/econ-ark-logo-small.png}}}

\ifbool{ntnu}{\date[2025-01-23]{Norwegian University of Science and Technology \\ \medskip 2025-01-23  \\ \medskip \medskip \medskip \href{https://econ-ark.org/}{\small Powered By} \\ \includegraphics[width=0.5in]{./@resources/econ-ark/econ-ark-logo-small.png}}}

\ifbool{upenn}{\date[2024-11-06]{University of Pennsylvania, 2024-11-06  \\ \medskip \medskip \medskip \href{https://econ-ark.org/}{\small Powered By} \\ \includegraphics[width=0.5in]{./@resources/econ-ark/econ-ark-logo-small.png}}}

\ifbool{bundesb}{
  \date[2023-07-06]{CEF - July 6, 2023  \\ \medskip \medskip \medskip
    \href{https://econ-ark.org/}{\small Powered By} \\ \includegraphics[width=0.5in]{econ-ark-logo-small.png}}}{}

\ifbool{fullcon}{
  \date[2026-06-02]{Montreal --- 2026-06-02  \\ \medskip \medskip \medskip
    \href{https://econ-ark.org/}{\small Powered By} \\ \includegraphics[width=0.5in]{./@resources/econ-ark/econ-ark-logo-small.png}}}{}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.7\linewidth}
      \includegraphics[width=.9\linewidth,height=0.7\textheight,keepaspectratio]{\latexroot/images/LorenzPoints_CRRA_2.0_R_1.01}
    \end{column}
  \end{columns}
  \medskip
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=.55\linewidth,height=0.65\textheight,keepaspectratio]{\latexroot/images/AggMPC_LotteryWin_comparison}
  \end{center}
...
\ifbool{fullcon}{
  ...
  \begin{frame}
    ...
    \includegraphics[width=3in,height=0.7\textheight,keepaspectratio]{\latexroot/images/AggMPC_LotteryWin_comparison}
    \begin{itemize}[<+->]
      \itemsep = .5\bigskipamount
      \item
  ...
  \begin{frame}
    ...
    \begin{tabular}{lccc}
      \hline
      \multicolumn{4}{l}{Parameters calibrated for each education group} %% array package: \multicolumn                                                \\ \hline
                                                                     & Dropout        & Highschool     & College        \\ \hline
      Percent of population                                          & \phantom{0}9.3 & 52.7           & 38.0           \\
      Avg.\ quarterly PI of ``newborn'' agent (\$1000)               & \phantom{0}6.2 & 11.1           & 14.5           \\
      Std.\ dev.\ of $\log($PI$)$ of ``newborn'' agent               & 0.32           & 0.42           & 0.53           \\
  ...
  \begin{frame}
    ...
    \centering
    \includegraphics[width=0.9\linewidth,height=0.75\textheight,keepaspectratio]{\latexroot/images/LorenzPoints_CRRA_2.0_R_1.01}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{columns}[onlytextwidth]
      ...
      \begin{column}{0.6\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.7\textheight,keepaspectratio]{\latexroot/images/recession_Check_relrecession}
      \end{column}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \begin{column}{0.50\textwidth}
        ...
        \includegraphics[width=\linewidth,height=0.75\textheight,keepaspectratio]{Code/HA-Models/FromPandemicCode/Figures/recession_UI_relrecession}
      \end{column}

      \begin{column}{0.50\textwidth}
        Payroll tax cut:
        \includegraphics[width=\linewidth,height=0.75\textheight,keepaspectratio]{Code/HA-Models/FromPandemicCode/Figures/recession_taxcut_relrecession}
      \end{column}
    \end{columns}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.50\textwidth}
      \centering
      \includegraphics[width=.9\linewidth,height=0.55\textheight,keepaspectratio]{\latexroot/images/IMPCs_wSplEstimated}
    ...
    \begin{column}{0.50\textwidth}
      \centering
      \includegraphics[width=.9\linewidth,height=0.55\textheight,keepaspectratio]{\latexroot/images/UnempSpell_Dynamics}
...
\begin{frame}
  ...
  \begin{columns}[onlytextwidth]
    ...
    \begin{column}{0.52\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=0.45\textheight,keepaspectratio]{Code/HA-Models/FromPandemicCode/Figures/Cumulative_multipliers}
    \end{column}
  \end{columns}

  \vspace{0.9em}
  \begin{center}
    {\small\textbf{Spending results}}
  \end{center}
  \vspace{-0.3em}
  \centering
  {\small
  \begin{tabular}{@{}l S[table-format=1.2] S[table-format=1.2] S[table-format=1.2]@{}}
    \toprule
                                                   & {\textbf{Stimulus check}} & {\textbf{UI extension}} & {\textbf{Tax cut}} \\
    \midrule
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.75\linewidth,height=0.75\textheight,keepaspectratio]{Code/HA-Models/FromPandemicCode/Figures/Cumulative_multipliers_withHank}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{\latexroot/images/IMPCs_both}
    \end{column}
    \begin{column}{0.5\textwidth}
      \includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{Code/HA-Models/FromPandemicCode/Figures/Splurge0/Cumulative_multipliers_SplurgeComp}
    \end{column}
  \end{columns}
  \begin{center}
    \begin{tabular}
