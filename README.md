...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19120432.svg)](https://doi.org/10.5281/zenodo.19120432)
...
[![Python](https://img.shields.io/badge/Python-3.9-blue.svg)](README/REPLICATION.md#3-installation-instructions)
...
- [REPLICATION.md § 3](README/REPLICATION.md#3-installation-instructions) — Installation and setup instructions
...
- **Installation**: See [README/REPLICATION.md § 3](README/REPLICATION.md#3-installation-instructions) for detailed setup instructions
...
- **Timing Estimates**: See [reproduce/benchmarks/README.md](reproduce/benchmarks/README.md) for hardware-specific timing data (consolidated timing table forthcoming — see plan part 2)
...
For detailed requirements, platform support, and dependency information, see [README/REPLICATION.md § 3](README/REPLICATION.md#3-installation-instructions).
...
**Timing Estimates**: See [reproduce/benchmarks/README.md](reproduce/benchmarks/README.md) for detailed timing information and hardware scaling data (consolidated timing table forthcoming — see plan part 2).
...
- **Windows Native**: Not supported; use WSL2 (see [README/REPLICATION.md § 3](README/REPLICATION.md#3-installation-instructions))
