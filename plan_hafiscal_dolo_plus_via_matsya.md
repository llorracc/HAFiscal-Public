...
| `HAFiscal-doloplus-from-matsya.yaml` (396 lines, mostly matsya prose around an embedded YAML; moved 2026-06-12 → `matsya_turns/turn1_from_matsya_transcript.yaml.md`) | Matsya's first-pass dolo-plus YAML attempt. Matsya itself flagged it as PROVISIONAL with "Several features: UNRESOLVED". Wrapped in a markdown narrative rather than a clean standalone YAML. | **Draft / needs replacement** |
...
| `HAFiscal-doloplus-from-matsya.yaml` | EXISTING DRAFT | Move to `archived_matsya_drafts/c6b255b2_doloplus.yaml` or delete; flag in PR — RESOLVED 2026-06-12: moved to `matsya_turns/turn1_from_matsya_transcript.yaml.md` |
