...
\begin{figure}[H] %float package: [H] option
  ...
  \noindent\begin{minipage}{\textwidth}
    ...
    \begin{subfigure}[b]{.32\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/recession_Check_relrecession.pdf}
      \caption{Check IRF}
    ...
    \begin{subfigure}[b]{.32\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/recession_UI_relrecession.pdf}
      \caption{UI extn IRF}
    ...
    \begin{subfigure}[b]{.32\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/recession_taxcut_relrecession.pdf}
      \caption{tax cut IRF}
    ...
    \begin{subfigure}[b]{.32\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/Cumulative_multiplier_Check.pdf}
    ...
    \begin{subfigure}[b]{.32\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/Cumulative_multiplier_UI.pdf}
    ...
    \begin{subfigure}[b]{.32\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/Cumulative_multiplier_TaxCut.pdf}
