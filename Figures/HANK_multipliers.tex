...
\begin{figure}[htb] 
  ...
  % Original path: \PathToRoot/Code/HA-Models/FromPandemicCode/Figures/Cumulative_multipliers_withHank
  \includegraphics[width=.9\textwidth]{\PathToRoot/images/Cumulative_multipliers_withHank}
