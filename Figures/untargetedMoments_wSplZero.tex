...
\begin{figure}[H]
  ...
  \noindent\begin{minipage}{\textwidth}
    ...
    \begin{subfigure}[b]{.48\linewidth}
      \centering
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/IMPCs_both.pdf}
    ...
    \begin{subfigure}[b]{.48\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/Splurge0/UIextension_CompSplurge0.pdf}
...
\noindent\parbox{\textwidth}{\footnotesize
  ...
  Green lines show income dynamics, demonstrating model consistency across specifications.
}
