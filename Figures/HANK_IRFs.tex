...
\begin{figure}[H]
  ...
  \noindent\begin{minipage}{\textwidth}
    ...
    \begin{subfigure}[b]{.30\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/HANK_transfer_IRF.pdf}
      \caption{Check IRF}
    ...
    \begin{subfigure}[b]{.30\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/HANK_UI_IRF.pdf}
    ...
    \begin{subfigure}[b]{.30\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/HANK_tax_IRF.pdf}
      \caption{Tax cut IRF}
    ...
    \begin{subfigure}[b]{.30\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/HANK_transfer_multiplier.pdf}
    ...
    \begin{subfigure}[b]{.30\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/HANK_UI_multiplier.pdf}
    ...
    \begin{subfigure}[b]{.30\linewidth}
      ...
      \frozenORcandidate[width=\linewidth]{\latexroot/Code/HA-Models/FromPandemicCode/Figures/HANK_tax_multiplier.pdf}
...
% UPDATED: 20250907-1330h Replaced manual \ifstandalone with smart \smartbib (auto-detects citations)
\smartbib
