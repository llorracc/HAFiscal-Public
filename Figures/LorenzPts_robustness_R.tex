...
\begin{figure}[htb]
  \centering
  \caption{\pregenmark Wealth distribution robustness: interest rate sensitivity}
  \whenintegrated{\label{fig:LorenzPts_robustness_R}} % integrated doc: SST for labels
  \frozenORcandidate[width=.9\textwidth]{\latexroot/Code/HA-Models/FromPandemicCode/LorenzPoints_robustness_R.pdf}
