...
> **Secondary script catalog (2026-06-13).** Use this file to identify helper
> scripts under `reproduce/`. The authoritative pipeline/runtime/output map is
> [`../Code/HA-Models/README.md`](../Code/HA-Models/README.md); the full
> repository authority map is [`../CLAUDE.md`](../CLAUDE.md). If runtime,
> output, or methodology details conflict, the owner docs win.
...
- Much faster than full computation; see `../Code/HA-Models/README.md` for
...
../reproduce.sh --comp full    # ~4-5 days (publication default; runs do_all.py steps 1, 2, 4, 5)
../reproduce.sh --comp max     # adds Step 3 (Splurge=0 robustness, ~21 h via HAFISCAL_RUN_STEP_3=true)
../reproduce.sh --docs main
```
...
- **Authority Map:** [`../CLAUDE.md`](../CLAUDE.md) - owner docs and conflict-resolution rules
- **Architecture:** [`../ARCHITECTURE.md`](../ARCHITECTURE.md) - human-facing repository map
- **Pipeline Owner:** [`../Code/HA-Models/README.md`](../Code/HA-Models/README.md) - computational steps, runtimes, outputs, and exhibit provenance
- **Environment Flags:** [`../Code/HA-Models/docs/ENV_FLAGS.md`](../Code/HA-Models/docs/ENV_FLAGS.md) - authoritative `HAFISCAL_*` registry
...
- **Installation:** [`REPLICATION.md § 3`](../README/REPLICATION.md#3-installation-instructions) - Platform-specific setup
...
- **Container Architecture:** [`../README_IF_YOU_ARE_AN_AI/WORKFLOWS.md`](../README_IF_YOU_ARE_AN_AI/WORKFLOWS.md) - System design
