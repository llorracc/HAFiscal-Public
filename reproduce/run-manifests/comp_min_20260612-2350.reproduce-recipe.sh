...
#   comp_min_20260612-2350.json
# Originally invoked as:
#   ./reproduce.sh --comp min --accept-unpushed
# At: 2026-06-12T23:50:33Z
# By: econ-ark@ECON-MW-7MYCC14 on linux-x86_64
# Wall clock: 80.0 seconds.

set -euo pipefail

ANCHOR_COMMIT="63d66dcfff5be8d64e3e7730053b48b4c871c714"
...
exec ./reproduce.sh --comp min --accept-unpushed
