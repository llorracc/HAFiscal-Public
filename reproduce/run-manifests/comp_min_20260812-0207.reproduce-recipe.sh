...
#   comp_min_20260812-0207.json
# Originally invoked as:
#   ./reproduce.sh --comp min
# At: 2026-08-12T02:07:05Z
# By: econ-ark@jhu-dell on linux-x86_64
# Wall clock: 228.0 seconds.

set -euo pipefail

ANCHOR_COMMIT="1133989f0639ca7c93684c8ef15d267f8455390b"
ANCHOR_BRANCH="0.14.1-to-0.17.0-upgrade-validation_TM-vs-MC"
ANCHOR_HARK_VERSION="0.17.2"
