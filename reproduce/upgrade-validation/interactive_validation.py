...
# upgrade it validated is COMPLETE. It would build a Python 3.9 + PyPI
# econ-ark==0.17.0 environment (this branch needs 3.10/3.11 + the pinned-git
# HARK with normalization/dual_measure) and checks for result files that never
# existed — so a rerun yields guaranteed false failures. See
