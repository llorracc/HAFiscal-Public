...
# upgrade it validated is COMPLETE. This harness expects result files that never
# existed (EstimResults.txt / AggFiscalResults.txt / SimulationResults.txt /
# AllResults.txt), its step labels diverge from do_all.py's canonical steps, and
# its sibling env builders pin the wrong Python/HARK (3.9 + PyPI econ-ark==0.17.0
# vs this branch's 3.10/3.11 + pinned-git HARK). Running it builds wrong
# environments and yields guaranteed false failures. See
