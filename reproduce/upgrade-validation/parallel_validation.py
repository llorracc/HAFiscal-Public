...
# upgrade it validated is COMPLETE. It builds wrong-version environments and
# checks for result files that never existed (see step_runner.py), so a rerun
# yields guaranteed false failures. See
