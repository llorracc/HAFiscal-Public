...
See [timing estimates](../reproduce/benchmarks/README.md) for hardware-specific duration data.
...
**Hardware matters**: See [timing estimates](../reproduce/benchmarks/README.md) for hardware-specific data and instructions to view actual benchmarks.
...
| **Full replication** | `./reproduce.sh --comp full` | See [timing estimates](../reproduce/benchmarks/README.md) | Medium |
