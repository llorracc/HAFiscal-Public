...
|------|---------|----------|
| `HAFiscal-dashboard.ipynb` | Root-level dashboard notebook | Repository root |
| `HAFiscal-jupyterlab.ipynb` | JupyterLab version | Repository root |
| `dashboard/app.ipynb` | Main Voila dashboard | `dashboard/` |
...
```bash
jupyter lab HAFiscal-jupyterlab.ipynb
```
