...
CDC_CALIBRATION_PINS = {
    # BUG-054 Option A (2026-07-27): the CDC Step-1 fit lives in the suffixed
    # Result_AllTarget_CDC.txt; the bare Result_AllTarget.txt is now a symlink
    # to the production (_ESC) file, so pinning the bare name would pin the ESC
    # bytes. Owner D3 ruling (same day): _CDC holds the noise-free TM-engine
    # re-derivation (0.25982/0.96232/0.07165, f0 0.0046345); the April-era
    # bytes (0.25710/..., sha beff9cd6...) live in git history.
    'Code/HA-Models/Target_AggMPCX_LiquWealth/Result_AllTarget_CDC.txt':
        'bfe42d0690f98cda2c85438325a1eec0c2a2c2be56b23b7cc646a6cfe928556e',
