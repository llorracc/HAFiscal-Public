...
# BUG-079 (2026-08-20): CDF-interpolated median of the gridded distribution (SST in
# Code/HA-Models/dist_quantile.py; HAFISCAL_STEP2_MEDIAN=node = the pre-fix snapping call).
...
from dist_quantile import step2_median as _step2_median
