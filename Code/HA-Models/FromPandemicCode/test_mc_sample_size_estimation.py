...
# TM reference
# ============================================================
print("Computing TM reference (dist_aGrid_count=200)...")
t0_tm = time()
dist_aGrid_count = 200
...
tm_AD = run_ad_tm(
    ...
    convergence_tol=0.004, mCount=dist_aGrid_count, verbose=False)
...
print(f"TM ratio (dist_aGrid_count={dist_aGrid_count}): {tm_ratio:.4f}")
...
print(f"  TM at dist_aGrid_count=200: ratio = {tm_ratio:.4f} (deterministic, ~50s)")
...
print(f"- TM reference: ratio = {tm_ratio:.4f} at dist_aGrid_count=200 (converged to 4 decimal places)")
