...
def macro0_baseline_aggcons(eco_template, interpretation, dist_aGrid_count=50):
...
def main():
    ...
    rec_baseline_tm_data = compute_baseline_tm_data(eco_rec, dist_aGrid_count=50, verbose=False)
    ...
    for agent in eco_pol.agents:
        agent.interpretation = interp
    pol_baseline_tm_data = compute_baseline_tm_data(eco_pol, dist_aGrid_count=50, verbose=False)
