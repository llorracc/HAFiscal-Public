...
bl_P = compute_baseline_tm_data(AggEco, dist_aGrid_count=50, neutral_measure=False, verbose=False)
bl_Q = compute_baseline_tm_data(AggEco, dist_aGrid_count=50, neutral_measure=True, verbose=False)
