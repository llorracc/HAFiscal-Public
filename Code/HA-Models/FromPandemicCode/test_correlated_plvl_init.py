...
if __name__ == "__main__":
    ...
    tm_data = compute_baseline_tm_data(eco_ref, dist_aGrid_count=100, neutral_measure=True)
    ...
    tm_B = compute_baseline_tm_data(eco_B, dist_aGrid_count=100, neutral_measure=True)
