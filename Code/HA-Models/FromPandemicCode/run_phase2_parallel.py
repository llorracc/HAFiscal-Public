...
def _emit_step2_provenance():
    ...
    try:
        ...
        _prov.emit([os.path.join(_ha, "Results")],
                   command=" ".join(sys.argv), argv=sys.argv,
                   label="step2-discfac-estimation", register=False)
