"""
mCount sweep: test whether TM's AD amplification ratio converges with grid resolution.
"""
...
print(f"\n{'mCount':>8s}  {'TE_noAD':>12s}  {'TE_AD':>12s}  {'AD/noAD':>10s}  {'time':>6s}")
print("-" * 55)
...
for mCount in [50, 100, 200, 400, 800]:
    ...
    tm_noAD = run_experiment_tm_nonbase(
        eco_ui, 'recessionUI', rec_path, bl_data, mCount=mCount, verbose=False)
    ...
    print(f"{mCount:8d}  {te_noAD:12.6f}  {te_AD:12.6f}  {ratio:10.4f}  {elapsed:5.0f}s")
