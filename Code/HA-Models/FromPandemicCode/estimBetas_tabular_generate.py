...
def main():
    ...
    # silently reads the bare CDC AllResults — which is what produced the 2026-07-28 promoted
    # table (beta_D 0.6556/0.3914 = the CDC file's values). Found 2026-08-20, spine4 prep.
