...
# interpretation. The Splurge0 file below has no ESC variant and stays bare.
...
resFileSplEst = open(input_path(_resolve_path(res_dir+'/AllResults_CRRA_2.0_R_1.01.txt')), 'r')  # interpretation-resolved (ESC)
