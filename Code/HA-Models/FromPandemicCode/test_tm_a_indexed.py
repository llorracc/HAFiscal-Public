...
def test_tm_a_indexed_flag_default(baseline_agent):
    ...
    bd_m = compute_baseline_tm_data(econ, dist_aGrid_count=30, neutral_measure=False,
                                    verbose=False)[0]
    ...
    bd_a = compute_baseline_tm_data(econ, dist_aGrid_count=30, neutral_measure=False,
                                    verbose=False)[0]
...
def test_phase_4_1_full_propagator_splurge_zero_equivalence(three_type_economy):
    ...
    out_m = run_experiment_tm(econ, shock_type='base', dist_aGrid_count=80,
                              verbose=False)
    ...
    out_a = run_experiment_tm(econ, shock_type='base', dist_aGrid_count=80,
                              verbose=False)
