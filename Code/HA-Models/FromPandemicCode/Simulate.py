def Simulate(Run_Dict,figs_dir,Parametrization='Baseline'):
    ...
    for ThisType in BaseTypeList:
        ...
        #
        # Under BUG_FIX (6-state) encoding the extension must instead be delivered as INCOME:
        ...
        if _ui_wiring == 'on' and _n_extension > 0:
            ...
            # U3/U4 micro indices: UBspell_normal+1 .. UBspell_normal+Policy_ExtraBenefitQuarters
            extension_micro_indices = list(range(
                UBspell_normal + 1, UBspell_normal + 1 + _n_extension))
            for macro_idx in range(n_macro):
                # Even macro index = "normal at time t", odd = "recession at time t".
                # The extension is active only during recession macro states (it expires
