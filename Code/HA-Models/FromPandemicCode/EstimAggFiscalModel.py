...
class AggFiscalType(MarkovConsumerType):
    ...
    def __init__(self,cycles=1,time_flow=True,**kwds):
        ...
        # solveOnePeriod (camelCase) is a dead attribute under HARK 0.17 —
        # core dispatches on solve_one_period, so this class silently fell
        # through to HARK's stock labels-aware solve_one_period_ConsMarkov
        # (probe-verified in the 2026-08-08 BUG-071-class sweep). This file
        # is production-dead (live Step-2 imports AggFiscalModel), but the
        # routing is restored so revival cannot arm the stale-labeled-dstn
        # bug class.
