...
def main():
    ...
    # NOTE: HAFISCAL_AGENTCOUNT_TOTAL is DEPRECATED (docs/ENV_FLAGS.md) — echo-only.
    # This print is its ONLY read in the repo; the env var has no behavioral consumer,
    # so a documented "=160000" recipe is a no-op. Real interface: --agent-count-total
    # (welfare6_scenario.py) or the HAFISCAL_AGENTCOUNT_{D,H,C} trio.
