...
OUTCOME STAMP (2026-06-09/10): the hypothesis above was tested and REFUTED in
its strong form — the residual check_rec gap (~+0.9%) does NOT vanish with
bucket/grid refinement; bucket-mean phi(pLvl) is a STRUCTURAL Jensen limit of
the bucketed formulation, not a discretization error. MC is canonical for the
check welfare cells (2026-06-10 unified-MC decision). The math stays above as
the tested hypothesis; see conclusions_private/2026-06-08_overnight_check_rec_
reconciliation.md and the 2026-06-10 decision doc.
