...
|---|---|---|---|---|
| no AD effects | $R = 1.005$ | 0.005 / 0.295 / 0.001 | 0.091 / -0.568 / 0.172 | 0.745 ± 0.065 / 1.367 ± 0.146 / 0.105 ± 0.013 (S=3) |
|  | $R = 1.01$ (baseline) | 0.011 / 0.509 / 0.002 | 0.157 / -1.131 / 0.308 | 0.995 ± 0.083 / 1.657 ± 0.159 / -0.015 ± 0.019 (S=5) |
|  | $R = 1.015$ | 0.014 / 0.666 / 0.003 | 0.227 / -1.575 / 0.432 | 1.836 ± 0.191 / 3.916 ± 0.421 / -0.113 ± 0.040 (S=3) |
| AD effects | $R = 1.005$ | 0.081 / 0.618 / 0.030 | 0.228 / -0.527 / 0.328 | 1.890 ± 0.066 / 1.710 ± 0.146 / 1.403 ± 0.014 (S=3) |
|  | $R = 1.01$ (baseline) | 0.151 / 1.101 / 0.056 | 0.424 / -1.052 / 0.609 | 3.239 ± 0.082 / 2.192 ± 0.166 / 2.524 ± 0.019 (S=5) |
|  | $R = 1.015$ | 0.215 / 1.496 / 0.081 | 0.614 / -1.461 / 0.868 | 5.153 ± 0.195 / 4.885 ± 0.423 / 3.613 ± 0.040 (S=3) |

## risk aversion

| | row | published check / UI / tax cut | THIS model, published formula | candidate check / UI / tax cut (S) |
|---|---|---|---|---|
| no AD effects | $\gamma = 2.0$ (baseline) | 0.011 / 0.509 / 0.002 | 0.157 / -1.131 / 0.308 | 0.995 ± 0.083 / 1.657 ± 0.159 / -0.015 ± 0.019 (S=5) |
|  | $\gamma = 3.0$ | 0.011 / 0.558 / 0.002 | 0.174 / -1.377 / 0.332 | 3.585 ± 0.882 / 2.937 ± 0.737 / -0.081 ± 0.036 (S=3) |
| AD effects | $\gamma = 2.0$ (baseline) | 0.151 / 1.101 / 0.056 | 0.424 / -1.052 / 0.609 | 3.239 ± 0.082 / 2.192 ± 0.166 / 2.524 ± 0.019 (S=5) |
|  | $\gamma = 3.0$ | 0.156 / 1.207 / 0.059 | 0.261 / -1.351 / 0.430 | 6.059 ± 0.870 / 3.495 ± 0.740 / 2.704 ± 0.038 (S=3) |

## benefits

| | row | published check / UI / tax cut | THIS model, published formula | candidate check / UI / tax cut (S) |
|---|---|---|---|---|
| no AD effects | Baseline ($\rho_b = 0.7$, $\rho_{nb} = 0.5$) | 0.011 / 0.509 / 0.002 | 0.157 / -1.131 / 0.308 | 0.995 ± 0.083 / 1.657 ± 0.159 / -0.015 ± 0.019 (S=5) |
|  | Altern. ($\rho_b = 0.3$, $\rho_{nb} = 0.15$) | 0.043 / 1.845 / 0.003 | 1.405 / 1.066 / 0.330 | 10.962 ± 1.027 / 16.942 ± 1.156 / 0.057 ± 0.028 (S=3) |
| AD effects | Baseline ($\rho_b = 0.7$, $\rho_{nb} = 0.5$) | 0.151 / 1.101 / 0.056 | 0.424 / -1.052 / 0.609 | 3.239 ± 0.082 / 2.192 ± 0.166 / 2.524 ± 0.019 (S=5) |
|  | Altern. ($\rho_b = 0.3$, $\rho_{nb} = 0.15$) | 0.157 / 2.514 / 0.048 | 1.768 / 1.186 / 0.722 | 13.827 ± 1.044 / 17.887 ± 1.170 / 3.172 ± 0.024 (S=3) |

## recession properties

| | row | published check / UI / tax cut | THIS model, published formula | candidate check / UI / tax cut (S) |
|---|---|---|---|---|
| no AD effects | Baseline | 0.011 / 0.509 / 0.002 | 0.157 / -1.131 / 0.308 | 0.995 ± 0.083 / 1.657 ± 0.159 / -0.015 ± 0.019 (S=5) |
|  | Shorter average recession, 4q | 0.010 / 0.424 / 0.002 | 0.132 / -0.972 / 0.247 | 0.828 ± 0.147 / 1.416 ± 0.257 / -0.007 ± 0.030 (S=3) |
|  | Stronger AD effects, 0.5 | 0.011 / 0.509 / 0.002 | 0.155 / -1.101 / 0.304 | 0.982 ± 0.150 / 1.658 ± 0.288 / -0.016 ± 0.035 (S=3) |
| AD effects | Baseline | 0.151 / 1.101 / 0.056 | 0.424 / -1.052 / 0.609 | 3.239 ± 0.082 / 2.192 ± 0.166 / 2.524 ± 0.019 (S=5) |
|  | Shorter average recession, 4q | 0.143 / 0.926 / 0.045 | 0.380 / -0.906 / 0.484 | 2.926 ± 0.150 / 1.828 ± 0.258 / 1.998 ± 0.029 (S=3) |
|  | Stronger AD effects, 0.5 | 0.297 / 1.695 / 0.110 | 0.684 / -0.948 / 0.886 | 5.450 ± 0.153 / 2.611 ± 0.289 / 4.897 ± 0.034 (S=3) |
...
|---|---|---|---|---|---|---|
| Baseline ($\rho_b = 0.7$, $\rho_{nb} = 0.5$) | the paper's window | 1.318 / 1.256 / 1.086 | 2.126 ± 0.039 | 1.785 ± 0.028 | 78.8 % | 5 |
| Baseline ($\rho_b = 0.7$, $\rho_{nb} = 0.5$) | history-consistent | 1.318 / 1.244 / 1.086 | 2.017 ± 0.035 | 1.716 ± 0.022 | 65.4 % | 3 |
| Altern. ($\rho_b = 0.3$, $\rho_{nb} = 0.15$) | the paper's window | 1.342 / 1.364 / 1.091 | 9.669 ± 0.345 | 9.122 ± 0.324 | 79.4 % | 3 |
| Altern. ($\rho_b = 0.3$, $\rho_{nb} = 0.15$) | history-consistent | 1.342 / 1.572 / 1.091 | 8.733 ± 0.177 | 7.991 ± 0.156 | 69.6 % | 3 |
