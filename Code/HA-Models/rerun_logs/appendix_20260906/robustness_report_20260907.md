...
|---|---|---|---|---|
| no AD effects | $R = 1.005$ | 0.005 / 0.295 / 0.001 | 0.091 / -0.568 / 0.172 | 0.605 ± 0.076 / 0.914 ± 0.145 / 0.112 ± 0.017 (S=3) |
|  | $R = 1.01$ (baseline) | 0.011 / 0.509 / 0.002 | 0.157 / -1.131 / 0.308 | 0.995 ± 0.083 / 1.657 ± 0.159 / -0.015 ± 0.019 (S=5) |
|  | $R = 1.015$ | 0.014 / 0.666 / 0.003 | 0.227 / -1.575 / 0.432 | 1.421 ± 0.222 / 2.503 ± 0.428 / -0.086 ± 0.052 (S=3) |
| AD effects | $R = 1.005$ | 0.081 / 0.618 / 0.030 | 0.228 / -0.527 / 0.328 | 1.746 ± 0.077 / 1.167 ± 0.146 / 1.406 ± 0.017 (S=3) |
|  | $R = 1.01$ (baseline) | 0.151 / 1.101 / 0.056 | 0.424 / -1.052 / 0.609 | 3.247 ± 0.084 / 2.150 ± 0.160 / 2.523 ± 0.019 (S=5) |
|  | $R = 1.015$ | 0.215 / 1.496 / 0.081 | 0.614 / -1.461 / 0.868 | 4.729 ± 0.225 / 3.219 ± 0.429 / 3.630 ± 0.050 (S=3) |
...
| AD effects | $\gamma = 2.0$ (baseline) | 0.151 / 1.101 / 0.056 | 0.424 / -1.052 / 0.609 | 3.247 ± 0.084 / 2.150 ± 0.160 / 2.523 ± 0.019 (S=5) |
...
|  | Altern. ($\rho_b = 0.3$, $\rho_{nb} = 0.15$) | 0.043 / 1.845 / 0.003 | 1.405 / 1.066 / 0.330 | 8.724 ± 1.188 / 11.170 ± 1.203 / 0.084 ± 0.041 (S=3) |
| AD effects | Baseline ($\rho_b = 0.7$, $\rho_{nb} = 0.5$) | 0.151 / 1.101 / 0.056 | 0.424 / -1.052 / 0.609 | 3.247 ± 0.084 / 2.150 ± 0.160 / 2.523 ± 0.019 (S=5) |
|  | Altern. ($\rho_b = 0.3$, $\rho_{nb} = 0.15$) | 0.157 / 2.514 / 0.048 | 1.768 / 1.186 / 0.722 | 11.540 ± 1.210 / 11.887 ± 1.217 / 3.163 ± 0.033 (S=3) |
...
| AD effects | Baseline | 0.151 / 1.101 / 0.056 | 0.424 / -1.052 / 0.609 | 3.247 ± 0.084 / 2.150 ± 0.160 / 2.523 ± 0.019 (S=5) |
...
|---|---|---|---|---|---|---|
| Baseline ($\rho_b = 0.7$, $\rho_{nb} = 0.5$) | the paper's window | 1.318 / 1.256 / 1.086 | 2.099 ± 0.037 | 1.785 ± 0.028 | 78.8 % | 5 |
| Baseline ($\rho_b = 0.7$, $\rho_{nb} = 0.5$) | history-consistent | 1.318 / 1.244 / 1.086 | 2.017 ± 0.035 | 1.716 ± 0.022 | 65.4 % | 3 |
| Altern. ($\rho_b = 0.3$, $\rho_{nb} = 0.15$) | the paper's window | 1.342 / 1.392 / 1.091 | 9.596 ± 0.432 | 9.004 ± 0.402 | 78.8 % | 3 |
