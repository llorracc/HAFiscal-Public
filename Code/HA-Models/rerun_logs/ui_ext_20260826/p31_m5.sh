#!/bin/bash
# P31 on ccarroll-m5 (rebalanced 2026-08-28 05:05): two appendix configs under the HISTORY UI policy (B), SEQUENTIAL after both P29 streams
...
LOG=$HOME/ui_ext_20260826; cd $FPC; source $HOME/p29_common.sh
...
echo "P31 M5 starting at $(git -C $W rev-parse --short HEAD) $(date +%H:%M:%S)"
cfgB Rfree_1015; cfgB ADElas
echo "P31 M5 DONE $(date +%H:%M:%S)"
