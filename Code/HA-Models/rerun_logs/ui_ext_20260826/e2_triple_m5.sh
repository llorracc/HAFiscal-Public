...
# MOVED TO ccarroll-m5 2026-08-28 12:40 (owner: use the Macs to speed progress): frees dell's battery slot for the Econ-1 arms.
...
echo "E2 TRIPLE DONE $(date +%H:%M:%S) on $(hostname)"
