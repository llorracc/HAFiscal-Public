...
if run_step_3:
    ...
    _py(_step2_script + " " + " ".join(args))  # same engine as Step 2 (default TM-ergodic)
...
if run_step_5:
    ...
    rc_tm = _py("AggFiscalMAIN_reduced.py --baseline", env_prefix=_tm_idx)
