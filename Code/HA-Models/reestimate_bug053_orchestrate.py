...
ran the whole chain UNATTENDED (user, 2026-06-09), re-architected after the pre-flight audit:
  ...
  GATE     halt unless 867 <= aMax <= 1600 (the actual code gate, GATE_LO/GATE_HI below —
           must cover the bucketed5d support; catches only an absurd broken-grid value).
           The executed run returned aMax=1300, PASSED, and 1300 is now production
           (HAFISCAL_TM_AMAX=1300 canonical default).
