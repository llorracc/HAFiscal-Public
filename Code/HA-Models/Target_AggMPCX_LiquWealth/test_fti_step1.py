...
# These tests exercise the transplant machinery across ALL methods, including
# the exp-pinned NAM/NAMG solvers, in their original (pre-flip) regime — so pin
# the legacy exp tail BEFORE importing fti_step1 (its F1 tail ROUTER, 2026-07-23,
# would otherwise correctly refuse the exp-pinned methods under the power-law
# default). The routed Anderson-powerlaw case is covered by
# Code/HA-Models/test_fti_tail_guard.py (fresh-interpreter cases).
os.environ["HAFISCAL_PF_DECAY_EXTRAP"] = "exp"
