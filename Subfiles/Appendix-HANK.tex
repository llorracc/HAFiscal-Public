...
\ifdefined\ShortVersion
  \ifdefined\IncludeAppendixInShort
    % Continue processing appendix content in SHORT mode when IncludeAppendixInShort is defined
  \else
    \endinput
  \fi
\fi
...
\subsection{\href{https://econ-ark.github.io/HAFiscal/\#sec:hank-calibration}{Calibration of nonhousehold blocks }}\whenintegrated{\label{sec:hank-calibration}}
