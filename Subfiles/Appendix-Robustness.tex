...
%		\whenintegrated{\label{tab:robustness_benefit_splurge}} % integrated doc: SST for labels
%	\end{center}
%\end{table}
%
%
...
% DEBUGGED: 20250907-1102h Fixed broken filename check (was checking 'Robustness' vs 'Appendix-Robustness') and LaTeX string comparison
% UPDATED: 20250907-1105h Consolidated: Use \whenstandalone for all standalone content
% FIXED: 20250921 Use smartbib to avoid multiple bibliography issue
\smartbib
