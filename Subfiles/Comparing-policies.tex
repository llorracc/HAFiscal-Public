...
The final impulse response graph, Figure~\ref{fig:recessiontaxcutrelrecession}, shows the impulse response for a payroll tax cut that persists for 2 years (eight quarters).
...
Therefore, the cumulative multiplier of the UI extension exceeds that of the stimulus check after about one year.
